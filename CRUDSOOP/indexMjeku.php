            ...
            <div>
                ...
                <div>
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <input type="text" name="sherbimi" value="<?php echo $sherbimi; ?>"
                                   class="form-control" placeholder="Sherbimi" required>
                        </div>
                        <div>
                            <!-- Add an input field to upload a new image -->
                            <input type="file" name="foto" class="custom-file">
                            <!-- Display the current image if available -->
                            <img src="../CRUDSOOP/uploads/" <?php echo $foto; ?> width="120" class="img-thumbnail">
                        </div>
                        <div>
                            <?php if ($update == true) { ?>
                    ...
                    <table id="data-table">
                        ...
                        <?php while ($row = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td><img src="../uploads/"<?php echo $row['foto']; ?> width="25"></td>
