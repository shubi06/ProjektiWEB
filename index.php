...
<body>
    ...
    <main>
        ...
        <div class="textbox">
                  ...
                  <div class="pjesa1">  <h2>Spitali më i vlerësuar <br> <span> në Europë. </span> 
                    <div class="paragrafi"> <p>Grieta është një platformë inovative shëndetësore  <br> që sjell një eksperiencë të re dhe të përmirësuar për pacientët. </p> </div>
                       <a style="text-decoration: none;" href="Termini.php" target="_blank"> <button class="btn"> CAKTO TERMININ </button></h2>  </a>
                </div>  
