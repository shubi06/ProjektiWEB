...
<header class="header" >
    ...
    <div class="background1">
        ...
        <div class="forma">
            <div class="forma1">
                <img style="height: 130px; width: 130px;" src="tel.png" alt="">
                <p>Telefoni</p>
                <p><span>+383 45 594 178</span></p>
            </div>
            <div class="forma1">
                <img style="height: 130px; width: 130px;" src="email.png" alt=""> 
                <p>Email</p>
                <p><span>info@grietahospital.com</span></p>
            </div>
            <div class="forma1">
                <img style="height: 130px; width: 130px;" src="loc.png" alt="">
                <p>Lokacioni</p>
...
<form action="" method="POST">
       ...
       <div class="butonicakto"> <button type="submit" name="butonicakto" style="    width: 100px; height: 30px; background-color: white; border: none;" onclick="return TERMINIvalidation()" value="Cakto"></div>
    </form>
...
if (orAiNputi.value=='') {
    ...
    // if(!SUrnameRegexx.test(SUrnameiNputi.value) && !NUmberRegexx.test(NumberiNputi.value) &&  !OrARegexx.test(orAiNputi.value) && !SHerbimiRegexx.test(sHerbimiNputi.value) && !DAtaRegexx.test(DAtaiNputi.value)){
    //     SUrnameiNputiERROR.style.color='red';
    //           NumberiNputiERROR.style.color='red';
    //           sHerbimiNputiERROR.style.color='red';
    //           orAiNputiERROR.style.color='red';
    ...
    //           sHerbimiNputiERROR.innerText='Wrong Service';
    //           orAiNputiERROR.innerText='Wrong Clock';
    //          DAtaiNputiERROR.innerText='Wrong Data';
    //           alert("Ju lutemi shkruani mire te dhenat !!");
    ...
    //     if(NAmmeRegexx.test(nAmeiNputi.value)){
    //         nAmeiNputiERROR.style.color='green';
    //         nAmeiNputiERROR.innerText='Correct Name';
    //         alert("true");
    //         return true;
    //     }
    ...
    //         if(SUrnameRegexx.test(SUrnameiNputi.value)){
    //             SUrnameiNputiERROR.style.color='green';
    //             SUrnameiNputiERROR.innerText='Correct Surname';
    //             if(!NAmmeRegexx.test(nAmeiNputi.value) && !NUmberRegexx.test(NumberiNputi.value) &&  !OrARegexx.test(orAiNputi.value) && !SHerbimiRegexx.test(sHerbimiNputi.value) && !DAtaRegexx.test(DAtaiNputi.value)){
    //          nAmeiNputiERROR.style.color='red';
    //         nAmeiNputiERROR.innerText='Wrong Name';
    //         NumberiNputiERROR.style.color='red';
    //          sHerbimiNputiERROR.style.color='red';
    ...
    //         if(NUmberRegexx.test(NumberiNputi.value)){
    //             NumberiNputiERROR.style.color='green';
    //             NumberiNputiERROR.innerText='Correct Number';
    //             if(!NAmmeRegexx.test(nAmeiNputi.value) && !SUrnameRegexx.test(SUrnameiNputi.value) &&  !OrARegexx.test(orAiNputi.value) && !SHerbimiRegexx.test(sHerbimiNputi.value) && !DAtaRegexx.test(DAtaiNputi.value)){
    //          nAmeiNputiERROR.style.color='red';
    //         nAmeiNputiERROR.innerText='Wrong Name';
    //          sHerbimiNputiERROR.style.color='red';
    //          orAiNputiERROR.style.color='red';
    ...
    //         if(SHerbimiRegexx.test(sHerbimiNputi.value)){
    //             sHerbimiNputiERROR.style.color='green';
    //             sHerbimiNputiERROR.innerText='Correct Service';
    //             if(!NAmmeRegexx.test(nAmeiNputi.value) && !SUrnameRegexx.test(SUrnameiNputi.value) &&  !OrARegexx.test(orAiNputi.value) && !NUmberRegexx.test(NumberiNputi.value) && !DAtaRegexx.test(DAtaiNputi.value)){
    //          nAmeiNputiERROR.style.color='red';
    //         nAmeiNputiERROR.innerText='Wrong Name';
    //          orAiNputiERROR.style.color='red';
    //          DAtaiNputiERROR.style.color='red';
    ...
    //         if(OrARegexx.test(orAiNputi.value)){
    //             orAiNputiERROR.style.color='green';
    //             orAiNputiERROR.innerText='Correct Clock';
    //             if(!NAmmeRegexx.test(nAmeiNputi.value) && !SUrnameRegexx.test(SUrnameiNputi.value) &&  !SHerbimiRegexx.test(sHerbimiNputi.value) && !NUmberRegexx.test(NumberiNputi.value) && !DAtaRegexx.test(DAtaiNputi.value)){
    //          nAmeiNputiERROR.style.color='red';
    //         nAmeiNputiERROR.innerText='Wrong Name';
    //          DAtaiNputiERROR.style.color='red';
    //          SUrnameiNputiERROR.style.color='red';
    ...
    //         if(DAtaRegexx.test(DAtaiNputi.value)){
    //             DAtaiNputiERROR.style.color='green';
    //             DAtaiNputiERROR.innerText='Correct Data';
    //             if(!NAmmeRegexx.test(nAmeiNputi.value) && !SUrnameRegexx.test(SUrnameiNputi.value) &&  !SHerbimiRegexx.test(sHerbimiNputi.value) && !NUmberRegexx.test(NumberiNputi.value) && !OrARegexx.test(orAiNputi.value)){
    //          nAmeiNputiERROR.style.color='red';
    //         nAmeiNputiERROR.innerText='Wrong Name';
    //          SUrnameiNputiERROR.style.color='red';
    //          NumberiNputiERROR.style.color='red';
    ...
    //             if(DAtaRegexx.test(DAtaiNputi.value) && NAmmeRegexx.test(nAmeiNputi.value) && SUrnameRegexx.test(SUrnameiNputi.value) &&  SHerbimiRegexx.test(sHerbimiNputi.value) && NUmberRegexx.test(NumberiNputi.value) && OrARegexx.test(orAiNputi.value)){
    //          nAmeiNputiERROR.style.color='green';
    //         nAmeiNputiERROR.innerText='Correct Name';
    //          SUrnameiNputiERROR.style.color='green';
    //          NumberiNputiERROR.style.color='green';
    ...
    //         NumberiNputiERROR.innerText='Correct Number';
    //         SUrnameiNputiERROR.innerText='Correct Surname';
    //          alert("Ju keni shkruajtur mire te dhenat !!");
    //                 return true;
    //             }
            
    //          if(!NAmmeRegexx.test(nAmeiNputi.value) && !SUrnameRegexx.test(SUrnameiNputi.value) && !NUmberRegexx.test(NumberiNputi.value) &&  !OrARegexx.test(orAiNputi.value) && !SHerbimiRegexx.test(sHerbimiNputi.value) && !DAtaRegexx.test(DAtaiNputi.value)){
    //         nAmeiNputiERROR.style.color='red';
    //         nAmeiNputiERROR.innerText='Wrong Name';
    //         SUrnameiNputiERROR.style.color='red';
    //          NumberiNputiERROR.style.color='red';
