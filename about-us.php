...
<section class="klasa1001" style="background-color: #f2f2f2; margin-bottom: -10px; margin-left: -7px; width: 1527px;">
...
<div class="container999" style="margin-top: 70px; width: 1527px;">
    <div class="box999" id="id999">
    <div class="kryesori-inside-1">
    <div class="mbrenda-1shit"  id="inside-1"><img clas="imazhi1" style=" width: 299px; border-radius: 16px;" src="foto7.png" alt="foto  e spitalit"></div>
    <div class="mbrenda-1shit"  id="inside-2"><img clas="imazhi2"style=" width: 299px; border-radius: 16px;" src="foto5.png" alt="foto  e spitalit"></div> 
    <div class="mbrenda-1shit"  id="inside-3"><img clas="imazhi3"style=" width: 299px; border-radius: 16px;" src="foto6.png" alt="foto  e spitalit"></div>
    <div class="mbrenda-1shit"  id="inside-4"><img clas="imazhi3"style=" width: 299px; border-radius: 16px;" src="foto8.png" alt="foto  e spitalit"></div>
    </div>
    </div>
    <div class="box999" id="id2">
        <h1 class="provide"  style="color:#008080; font-size: 30px; margin-top: 80px; padding-right: 50px;">About Us</h1>
        <div class="provide"id="c2">
            <br>
        <p class="animate__animated animate__bounce   animation: bounce; animation-duration: 4s" id="tektsti999" style="font-weight: 540";>We provide the best medical Care Treatment for your health</p>
        <p class="animate__animated animate__bounce animate__repeat-2" id="tektsti999" style="margin-top: 30px; font-weight: 540;">We provide the special steps and advice of health care treatment and high level of best technology involve is the our hospital.</p>
        </div>
    
            <div class="provide"id="c3" style="font-weight: 550;">
    ...
    <section class="footerFoRsHerbimet">
        <section class="klasaefooterit">
          <div class="main999" style="margin-top: -100px;">
            <div class="d1">
                <div class="g">
