...
<header class="header" >
    ...
    <section class="footerFoRsHerbimet" style="background-color: #f2f2f2;">
      <section class="klasaefooterit">
        <div class="main999"><!--/style="margin-top: 80px;"-->
          <div class="d1">
              <div class="g">
                  <div style="display: flex; align-items: center;">
                      <img src="logo_+.png" style="width: 40px;" alt="+logo">
                      <h1 style="color: #389c84; padding-left: 10px;">Get Appointment</h1>
                  </div>
