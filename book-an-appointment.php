 ...
 <div class="kryesori111">
  ...
  <div class="divv2">
    ...
    <form action="" method="POST">
      ...
      outline: none; margin-left: 35px; font-size: 1.2em; font-family:'Times New Roman', Times, serif;" type="text" id="emri" name="emri" placeholder="Shkruani emrin" required><label  style="margin-right: 10px;" id="nameerror2"></label>
    </div>
    <div class="divv2">
    ...
    <div class="divv2">
      <input class="inputat" type="text" id="phone" name="numri" placeholder="Shkruani numrin e telefonit" style="width: 200px;  background-color:rgb(0, 128, 128);
      border: none;
      margin-top: 35px;
      background: transparent;
    ...
    <div class="divv2">
      ...
      margin-top: 35px;
      background: transparent;
      outline: none; font-size: 1.2em; font-family:'Times New Roman', Times, serif;" type="email" id="service" name="email" placeholder="Shkruani emailen" required><label id="Serviceerror2"></label>
    </div>
    
    </div>
    <div class="nder" style="padding-left: 20px;">
    <input class="input-ne-veti" id="input-1" type="textarea" name="mesazhi" placeholder="Shkruani mesazhin" style=" border: none; outline: none; background: transparent; margin-left: 115px; font-size: 1.2em; font-family:'Times New Roman', Times, serif;"  required><label id="Emaileerror3"></label>
    </div>
