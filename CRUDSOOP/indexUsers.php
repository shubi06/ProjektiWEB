...
if (isset($_SESSION['role_as'])) {
 ...
 $updateData = $usersController->edit(); 
 $update = !empty($updateData);
 
 $update = isset($updateData['id']);
 $id = $update ? $updateData['id'] : '';
 $emri = $update ? $updateData['emri'] : '';
 $mbiemri = $update ? $updateData['mbiemri'] : '';
 $email = $update ? $updateData['email'] : '';
 $password = $update ? $updateData['password'] : '';
 $cpassword = $update ? $updateData['cpassword'] : '';
 $role_as = $update ? $updateData['role_as'] : '';
?>
                ...
                <div>
                    ...
                    <div>
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                <input type="text" name="emri" value="<?php echo  $emri; ?>" class="form-control"
                                    placeholder="Emri" required>
                            </div>
                            <div>
                                <input type="text" name="mbiemri" value="<?php echo  $mbiemri; ?>" class="form-control"
                            ...
                            <div>
                                <input type="number" name="role_as" value="<?php echo  $role_as; ?>"
                    ...
                    <table id="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="detailsOOPUsers.php?details=<?php echo  $row['id']; ?>">Details</a> |
                                    <a href="indexUsers.php?delete=<?php echo  $row['id']; ?>"
                                        onclick="return confirm('Do you want delete this record?');">Delete</a> |
                                    <a href="indexUsers.php?edit=<?php echo  $row['id']; ?>">Edit</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
